...
@class NSError, NSObject<IPHPhotoDBProtocol>, NSObject<IPHPluginManagerProtocol>, NSString, NSURL;

@interface IPHPublishServiceFlickrBase : NSObject <IPHPublishServiceProtocol>
{
...
+ (id)keychainURLForDefaultUsername;
